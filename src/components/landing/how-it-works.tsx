...
const RoadmapB2B = () => {
    const renderStep = (step: (typeof b2bSteps)[0], index: number) => (
        <div className="flex flex-col items-center text-center max-w-xs group hover:transform hover:scale-105 transition-all duration-300">
            ...
            <div className="container mx-auto max-w-7xl px-4">
                ...
                <Tabs defaultValue="b2b" className="w-full">
                    ...
                    <TabsContent value="b2b" className="mt-16">
                        <div className="bg-slate-800/70 backdrop-blur-md rounded-2xl shadow-2xl border border-slate-700/50 p-8">
